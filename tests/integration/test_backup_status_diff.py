...
def test_backup_creates_files_and_metadata(isolated_env) -> None:
...
def test_current_symlink_updates(isolated_env) -> None:
    root = isolated_env["root"]
...
def test_status_unchanged_after_backup(isolated_env) -> None:
...
def test_status_detects_modified(isolated_env) -> None:
    run_backup(root=isolated_env["root"], config_path=isolated_env["config"])
...
def test_status_detects_missing(isolated_env) -> None:
    run_backup(root=isolated_env["root"], config_path=isolated_env["config"])
...
def test_diff_returns_unified_text(isolated_env) -> None:
